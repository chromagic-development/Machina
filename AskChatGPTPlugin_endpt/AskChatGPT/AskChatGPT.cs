// AskChatGPT_endpt VM plugin: Get response_p from prompt using LLM AI
// v1.0.0.0
...
namespace AskChatGPTPlugin
{
    ...
    public class VoiceMacro : vmInterface
    {
        ...
        // Argument 1: OpenAI API endpoint
        // Argument 2: OpenAI model
        // Argument 3: Prompt text
        private static async Task<string> AskChatGPT(string apiUrl, string model, string prompt)
        {
