...
3. <a href="https://www.voicemacro.net/download">Download</a> and install VoiceMacro and accept all defaults.
...
9. Make sure the Initialize Machina macro is set to (Auto).
