// GetCommand_endptWhisper VM plugin: Get command_p text using voice AI STT
// v1.0.0.0
// Uses OpenAI Whisper instance
...
namespace GetCommandPlugin
{
    ...
    public class VoiceMacro : vmInterface
    {
        ...
        static async Task<string> GetSTT(string apiUrl, int maxDurationSeconds, int silenceThreshold)
        {
