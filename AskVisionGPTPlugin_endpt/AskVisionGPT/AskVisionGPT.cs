// AskVisionGPT_endpt VM plugin: Get response_p from prompt using LLM Vision AI
// v1.0.0.0
...
namespace AskVisionGPTPlugin
{
    ...
    public class VoiceMacro : vmInterface
    {
        ...
        // Argument 3: Prompt text
        private static async Task<string> AskVisionGPT(string apiUrl, string rtspUrl, string text)
        {
